...
const MainLayout = () => {
    return <div className="w-full h-screen flex">
        ...
        <div className="w-full bg-green-600 h-full">
            <div className="w-full bg-[#ecf0f1] h-14 px-3.5">
                <div className="h-full w-full flex justify-between items-center">
                    ...
                    <div class="w-[60%]">
                        ...
                        <form class="w-full">
                            <label for="default-search" class="mb-2 text-sm font-medium text-[#1abc9c] sr-only dark:text-white">Search</label>
                            <div class="relative">
                                ...
                                <input type="search" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-[#1abc9c] focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Mockups, Logos..." required />
